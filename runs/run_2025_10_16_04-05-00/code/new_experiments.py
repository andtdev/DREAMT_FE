...
print("Class weights (higher = more penalty for misclassification):")
for class_idx, class_name in enumerate(class_names):
    print(f"  {class_name}: {class_weights[class_idx]:.3f} (n={class_counts[class_idx]})")
...
# Train LightGBM multiclass model with cost-sensitive learning
print("\nTraining LightGBM multiclass model with cost-sensitive learning...")
print("Using class weights to penalize minority class misclassifications more heavily...")
