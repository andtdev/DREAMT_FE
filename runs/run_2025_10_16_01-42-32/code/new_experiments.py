...
# For binary classification, shap_values is a list [class_0, class_1], we use class_1 (positive class)
shap_beeswarm_plot_path = f"{output_dir}/LightGBM_shap_tree_explainer_beeswarm.png"
...
plt.close()
print(f"SHAP tree explainer beeswarm plot saved to: {shap_beeswarm_plot_path}")
