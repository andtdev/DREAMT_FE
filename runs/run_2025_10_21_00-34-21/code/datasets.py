...
def map_stages_to_numeric(df):
    ...
    Mapping (N2 and N3 merged):
    - W (Wake): 0
    - R (REM): 1
    - N1: 2
    - N2+N3 (merged NREM stages): 3
    ...
    df_copy : pandas DataFrame
        Copy of dataframe with Sleep_Stage as numeric labels (0-3)
    stage_to_num : dict
    ...
    # Merge N2 and N3 into a single class (both map to 3)
    stage_to_num = {'W': 0, 'R': 1, 'N1': 2, 'N2': 3, 'N3': 3}
    num_to_stage = {0: 'W', 1: 'R', 2: 'N1', 3: 'N2+N3'}
